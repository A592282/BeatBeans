                        ...
                        <table id="background-image">
                            ...
                            <tbody>
                                ...
                                <tr id="ProdDiv<?php echo $SelectedFoodItem->SelectedProductId?>">
                                    ...
                                    <td><div id="info<?php echo $SelectedFoodItem->SelectedProductId; ?>"></div><img src="images/buttons/updateplate.png" style="cursor: pointer" name="update" value="update" onclick="Update(<?php echo $SelectedFoodItem->SelectedProductId?>,<?php echo $SelectedFoodItem->ShopId ?>)"/></td>
