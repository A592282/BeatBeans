...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head runat="server" >
        <title>New Password | Beat Beans :-)</title>
                ...
                $("#registerHere").validate({
                    ...
                    messages: {
                        password: {
                            ...
                            emailminlength: "Password better if minimum 6 characters"
                        }
                    },
...
<link href="css/sunny/jquery-ui-1.9.1.custom.css" rel="stylesheet" />
    ...
    <body>
        ...
        <div id="container" >
            ...
            <div id="content">
                <br/><br/><br/><br/>
                 <form class="form-horizontal" id="registerHere" action='BusinessLogicLayer/BL_ConfirmResetPassword.php' method='post' accept-charset='UTF-8'>
                        <fieldset >
                            <legend>New Password</legend>
                            <input type='hidden' name='id' id='id' value='<?php echo $_GET['id']?>'/>
                            <br/><br/><br/>
                            <div class="control-group">
                                <label class="control-label" for="input01">New Pa-shhhh...word</label>
                                <div class="controls">
                                    <input type="password" class="input-xlarge" id="password" name="password" rel="popover" data-content="New Password.Better if more than 6 char! Be tricky" data-original-title="Password" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <button type="submit" class="btn btn-success" rel="tooltip" title="first tooltip">change Password</button>
                                </div>
                            </div>
                            <hr/>
